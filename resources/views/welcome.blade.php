...
@section('content')
    <div class="flex flex-col justify-center min-h-screen py-4 dark:bg-slate-900 sm:px-6 lg:px-8 w-[100%]">
        ...
        <div class="flex flex-col items-center justify-center">
            <div class="space-y-1 sm:hidden">
                <a href="{{ route('home') }}">
                    <x-logo class="sm:flex w-auto h-16 mx-auto text-pink-600" />
                </a>

                <h1 class="font-serif font-extrabold text-transparent text-center sm:flex text-7xl bg-clip-text bg-gradient-to-r from-purple-400 to-pink-600">
                    {{ config('app.name') }}
                </h1>
            </div>
            @livewire("detect-sms")
